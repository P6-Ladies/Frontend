...
export default function HomePage () {
    ...
    return (
        ...
        <div className= "fixed top-5 right-5"><button className="bg-yellow-800 text-white px-6 py-3 rounded-full shadow-lg hover:bg-yellow-700 transition-all"
        onClick={e => {//Also add so that your web token is delete
            router.push('/login')}}> Log out</button></div>
